...
/* 自定义脚本位置 */
static const char *autostartscript = "/home/intmax/apps/dwm/autostart.sh";
static const char *statusbarscript = "/home/intmax/apps/dwm/statusbar/statusbar.sh";
...
static Key keys[] = {
    ...
    { MODKEY,              XK_d,        spawn, SHCMD("dolphin") },                                                /* super d          | 打开文件管理          */
    { MODKEY,              XK_c,        spawn, SHCMD("google-chrome-stable") },                                   /* super c          | 打开chrome           */
    { MODKEY|ShiftMask,    XK_a,        spawn, SHCMD("flameshot gui -c -p ~/Pictures/screenshots") },             /* super shift a    | 截图                 */
    { ControlMask,         XK_c,        spawn, SHCMD("xclip -selection c -i") },                                  /* ctrl c           | 复制                 */
    { ControlMask,         XK_v,        spawn, SHCMD("xclip -selection c -o") },                                  /* ctrl v           | 复制                 */
    { MODKEY,              XK_r,        spawn, SHCMD("rofi -show drun") },                                        /* super r          | rofi: drun        */
    { MODKEY|ShiftMask,    XK_r,        spawn, SHCMD("rofo -show run") },                                         /* super shift r    | rofi: run       */
